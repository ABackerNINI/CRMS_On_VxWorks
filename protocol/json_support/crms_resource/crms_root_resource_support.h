...
struct njson_support<crms::protocol::resource::resource::CRMS_RootResource> {
    static bool is_default_value(const crms::protocol::resource::resource::CRMS_RootResource &njson_var) {
        return false;
    }

    static void serialize(JSON_Value *njson_val, const char *njson_name,
                          const crms::protocol::resource::resource::CRMS_RootResource &njson_var) {
