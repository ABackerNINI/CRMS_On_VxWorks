...
#ifndef _CRMS_JSON_PRIMITIVE_CONTENT_TYPE_SERIALIZATION_H_
#define _CRMS_JSON_PRIMITIVE_CONTENT_TYPE_SERIALIZATION_H_
...
#endif //_CRMS_JSON_PRIMITIVE_CONTENT_TYPE_SERIALIZATION_H_