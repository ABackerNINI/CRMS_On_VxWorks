...
void crms::protocol::agent::resource_handler::node_handler::Create(resource::primitive::CRMS_Req *req,
                                                                  resource::primitive::CRMS_Rsp *rsp,
...
void crms::protocol::agent::resource_handler::node_handler::Retrieve(crms::protocol::resource::primitive::CRMS_Req *req,
...
void crms::protocol::agent::resource_handler::node_handler::Update(crms::protocol::resource::primitive::CRMS_Req *req,
                                                                  crms::protocol::resource::primitive::CRMS_Rsp *rsp,
                                                                  crms::protocol::resource::resource::CRMS_Resource *res) {
    resource_operator::resource_operator::update_resource(req, rsp, res);
}

void crms::protocol::agent::resource_handler::node_handler::Delete(crms::protocol::resource::primitive::CRMS_Req *req,
                                                                  crms::protocol::resource::primitive::CRMS_Rsp *rsp,
                                                                  crms::protocol::resource::resource::CRMS_Resource *res) {
