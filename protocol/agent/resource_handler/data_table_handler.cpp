...
void
crms::protocol::agent::resource_handler::data_table_handler::Create(crms::protocol::resource::primitive::CRMS_Req *_Req,
...
void crms::protocol::agent::resource_handler::data_table_handler::Retrieve(
...
void
crms::protocol::agent::resource_handler::data_table_handler::Update(crms::protocol::resource::primitive::CRMS_Req *_Req,
                                                                    crms::protocol::resource::primitive::CRMS_Rsp *_Rsp,
                                                                    crms::protocol::resource::resource::CRMS_Resource *_Res) {
...
void
crms::protocol::agent::resource_handler::data_table_handler::Delete(crms::protocol::resource::primitive::CRMS_Req *_Req,
                                                                    crms::protocol::resource::primitive::CRMS_Rsp *_Rsp,
                                                                    crms::protocol::resource::resource::CRMS_Resource *_Res) {
