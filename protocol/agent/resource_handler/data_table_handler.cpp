...
void
crms::protocol::agent::resource_handler::data_table_handler::Create(crms::protocol::resource::primitive::CRMS_Req *req,
...
void
crms::protocol::agent::resource_handler::data_table_handler::Update(crms::protocol::resource::primitive::CRMS_Req *req,
                                                                    crms::protocol::resource::primitive::CRMS_Rsp *rsp,
                                                                    crms::protocol::resource::resource::CRMS_Resource *res) {
...
void
crms::protocol::agent::resource_handler::data_table_handler::Delete(crms::protocol::resource::primitive::CRMS_Req *req,
                                                                    crms::protocol::resource::primitive::CRMS_Rsp *rsp,
                                                                    crms::protocol::resource::resource::CRMS_Resource *res) {
