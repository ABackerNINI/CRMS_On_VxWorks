...
#ifndef CRMS_ON_VXWORKS_REMOTE_ATTRIBUTE_HANDLER_H
#define CRMS_ON_VXWORKS_REMOTE_ATTRIBUTE_HANDLER_H
    ...
    namespace protocol {
        ...
        namespace agent {
            ...
            namespace resource_handler {
                ...
                class remote_attribute_handler {
                public:
...
#endif //CRMS_ON_VXWORKS_REMOTE_ATTRIBUTE_HANDLER_H
