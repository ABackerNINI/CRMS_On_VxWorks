...
#ifndef CRMS_ON_VXWORKS_REMOTE_RESOURCE_OBJECT_HANDLER_H
#define CRMS_ON_VXWORKS_REMOTE_RESOURCE_OBJECT_HANDLER_H
    ...
    namespace protocol {
        ...
        namespace agent {
            ...
            namespace resource_handler {
                ...
                class remote_resource_object_handler {
                public:
...
#endif //CRMS_ON_VXWORKS_REMOTE_RESOURCE_OBJECT_HANDLER_H
