...
#ifndef _CRMS_RESOURCE_REMOTE_RESOURCE_OBJECT_HANDLER_H_
#define _CRMS_RESOURCE_REMOTE_RESOURCE_OBJECT_HANDLER_H_
...
#endif //_CRMS_RESOURCE_REMOTE_RESOURCE_OBJECT_HANDLER_H_
